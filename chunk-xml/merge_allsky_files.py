...
@createdOn      : July 2024
@description    : This script reads multiple data files produced by the "ObservingScenariosInsights/chunk-xml/ligoSkymap_statistics.sh", 
                  merges them into a single table, and saves the merged table in a specified format.
---------------------------------------------------------------------------------------------------
"""
...
input_file_1 = Path("./runs/O4/farah/chunky/allsky_chunk1.dat")
input_file_2 = Path("./runs/O4/farah/chunky/allsky_chunk2.dat")
input_file_3 = Path("./runs/O4/farah/chunky/allsky_chunk3.dat")
...
# Merge the tables
try:
    allsky_merged = vstack([allsky_1, allsky_2, allsky_3], join_type='exact')
